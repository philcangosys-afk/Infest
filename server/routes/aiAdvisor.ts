...
export const handleAiAdvisor: RequestHandler = async (req, res) => {
  ...
  const systemPrompt = isFollowup
    ...
    : service === "business_model"
      ? "أنت مستشار نماذج أعمال وتمويل احترافي. اعتمد فقط على الأرقام الموجودة فعلياً في النص المستخرج من ملف الدراسة المرفق. اقتبس الأرقام كما هي (تكاليف، رواتب، إيرادات، إيجار، أعداد العمال، الميزانية، الأسعار)، واربط كل رقم بالبند الذي ذكره الملف. ممنوع اختراع أرقام عامة. إذا اضطررت لافتراض رقم حرج اكتب أمامه [افتراض] واشرح أساس الحساب."
      : role === "investor"
