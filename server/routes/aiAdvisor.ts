...
const getServiceGuidance = (role: AdvisorRole, service: string) => {
  ...
  if (service === "business_model") {
    return [
      ...
      "ممنوع الأرقام العشوائية. استخدم الأرقام الموجودة في الدراسة المرفوعة. إذا غاب رقم معين اذكر أنه غير متوفر وضعه ضمن قائمة البيانات الناقصة.",
    ].join("\n");
  }
  ...
  const userPrompt = isFollowup
    ...
    : [
        ...
        extractedDocumentText
          ...
          : "تعذر استخراج نص كافٍ من ملف PDF. اعتمد فقط على الملخص المقدم بدون اختراع أرقام.",
